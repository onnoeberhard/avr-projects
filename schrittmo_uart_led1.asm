...
;	push temp2						; für Schrittmotor, erste 2 Pins durch UART belegt
;	ldi  temp2, 0b00100100		; 4+1
;	out  PORTD, temp2
;	rcall delay_long

;	ldi temp2,  0b00010100		; 3+1
;	out PORTD,  temp2
;	rcall delay_long

;	ldi temp2,  0b00011000		; 3+2
;	out PORTD,  temp2
;	rcall delay_long

;	ldi temp2,  0b00101000		; 4+2
;	out PORTD,  temp2
;	rcall delay_long
;	pop temp2
